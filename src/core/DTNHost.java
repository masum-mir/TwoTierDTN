...
public class DTNHost implements Comparable<DTNHost> {
	...
	/**
	 * Freezes/unfreezes this host. A frozen host does not move and its
	 * router is not updated (effectively offline — e.g. battery depleted).
	...
	/**
	 * Returns true if this host is frozen (e.g. out of energy).
	...
	public void forceConnection(DTNHost anotherHost, String interfaceId,
		...
		if (interfaceId != null) {
			...
			assert (ni.getRadioGroup().equals(no.getRadioGroup())) :
				"Interface radio groups do not match. Please specify interface type explicitly";
		}
	...
	public void update(boolean simulateConnections) {
		if (this.frozen) {
	        ...
	        return; // frozen: no scanning, no connections, no router update
	    }
	...
	public void move(double timeIncrement) {
		...
		if (this.frozen || !isMovementActive() || SimClock.getTime() < this.nextTimeToMove) {
			return;
		}
